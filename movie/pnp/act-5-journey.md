...
**Agents:** Chris + Jun-seo
**Portals:** Consultant + Immigrant
**Duration:** Work permit → arrive → work → PR approved

---

## Chapter 5.1 — Work Permit
...
### Scene 5.1.2 — Work Permit Approved
**Agent: Chris**
- Work permit approved — 2 years
- Messages: "Jun-seo, work permit approved. You can fly to Vancouver and start at Sanctuary AI. Your PR application continues processing in the background. You don't need to wait."
- Jun-seo: "Booking my flight. See you in Vancouver."

## Chapter 5.2 — Landing

### Scene 5.2.1 — Arrival in Vancouver
**Agent: Jun-seo (narrated)**
- Flies Seoul → Vancouver
- CBSA stamps work permit at YVR
- Takes SkyTrain to downtown
- Arrives at Sanctuary AI's office on Monday morning
- First day at work — meets the robotics team
- Thinks: "3 months ago I was debugging kinematics at Hyundai. Now I'm building humanoid robots in Vancouver."

### Scene 5.2.2 — Chris Updates
**Agent: Chris**
- Updates case: "Jun-seo landed, work permit activated, employment started"
- PR application continues processing in background
- No further documents needed — just wait
- Logs 1 hour → retainer balance: $1,250

## Chapter 5.3 — PR Processing

### Scene 5.3.1 — Background Check (Months 4-6)
**Agent: Chris (periodic)**
- Korean passport — background check is straightforward
- No extended delays (unlike Syrian or Iranian passports)
- Monthly check-ins with Jun-seo — mostly "no update, processing normally"
- Jun-seo is busy at Sanctuary AI — barely notices the wait

### Scene 5.3.2 — Medical Completed
- Already done in Seoul before arrival
- Valid for 12 months — still current

## Chapter 5.4 — PR Approved

### Scene 5.4.1 — COPR Letter (Month 8)
**Agent: Chris**
...
**Agent: Jun-seo**
- Portal: ✅ PERMANENT RESIDENT
- Timeline: complete — all milestones green
- 8 months total. Fastest of Chris's 3 clients.
- Thinks: "8 months. A LinkedIn message to permanent residence. I'm building robots in Vancouver and I'm not leaving."

### Scene 5.4.3 — Jun-seo's Portal — Final State
- Status: Approved — Permanent Resident
- Documents: 10/10
- Timeline: Retainer → PNP nomination (6 weeks) → ITA (2 weeks) → Work permit (5 weeks) → PR (5 months)
- Employer: Sanctuary AI, Vancouver
- Consultant: Chris Daw, RCIC R409583

### Scene 5.4.4 — Chris's Dashboard — Final State
- 3 completed cases:
